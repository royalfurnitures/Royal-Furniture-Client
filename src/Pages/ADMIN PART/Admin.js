...
export const Admin = () => {
  ...
  return (
    ...
    <div className='bg-white'>
      <div className='flex items-center fixed left-0 right-0 top-0 text-black z-50 text-[20px] lg:text-[40px]' > 
        ...
        <div className='text-lg lg:text-5xl font-bold text-orange-500 flex items-center justify-center py-10 fixed left-0 right-0 top-0 bg-white '>Royal Furniture Admin </div>
        {/* <button className='block lg:hidden' onClick={()=>MenuOpenHandler()}>Menu</button> */}
         <div className={` ${ismenu ? "block" :"hidden"}  h-[93vh] lg:h-[100vh]  lg:block  lg:w-[300px]  border-[2px] rounded-lg p-4 fixed z-10 top-[60px] lg:top-0 bg-white `}>
