...
import { BlogDeleteAPIHandler, DeleteGalleryAPIHandler, GetAllPhotoHandler, GetBlogByModuleAPIHandler, ModulesDeleteGalleryAPIHandler } from '../../API/APIS';
...
const DisplayDesignIdeas = () => {
  ...
  return (
    <div className='lg:flex'>
        ...
        {
          isCreate ? 
          <CreateEditBlog tab={type}  Datahandler={()=>{GetBlogsByModule(Tab)}} iscreate={true} openHandler={handler} />
          :
          null
        }
         {
          isEdit ? 
          <CreateEditBlog tab={type} Datahandler={()=>{GetBlogsByModule(Tab)}} isedit={true} editdata={editData} openHandler={Edithandler} />
          :
          null
        }
