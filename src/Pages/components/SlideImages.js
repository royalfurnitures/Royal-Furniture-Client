  ...
  return (
    <Fragment>
         <div className='grid grid-cols-3 gap-4 '>
          ...
          <Link to={`/designideas/${item.matchedDocuments[0].Title}/${link}`} className='col-span-3 md:col-span-1  '>
             <div className='w-[100%] h-[300px]   bg-[#424242]  relative' >
              <img src={item.matchedDocuments[0].Images[0].URL} className='w-[100%]   h-[100%]  object-cover' />
              <div className='absolute w-[100%] z-10 bottom-2 left-2 text-white'>{item.matchedDocuments[0].Title}</div>
