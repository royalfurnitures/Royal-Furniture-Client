...
const cards = [
  ...
  const images1 = [
    { src: fo, link: '' ,text: 'Front Office ' },//1
    { src: cafe, link: '' ,text: 'Conference' },//2
    { src: exdes, link: '' ,text: 'Work station' },//3
    { src: seat, link: '' ,text: 'Executive desk' },//4
    { src: conf, link: '' ,text: 'Seating' },//5
  ...
  return (
    <div>
      ...
      <div className="title-container">
             ...
             <h1 className="title gilroyBold text-r-tvoi text-xl md:text-2xl lg:text-4xl  text-justify">Experience the Journey of   <span className=' md:hidden'>&nbsp;&nbsp;&nbsp;</span>  Conceptualizing , Creating and <span className=' md:hidden'>&nbsp;&nbsp;</span> Conquering Your Office Interiors!</h1>
             </div>
             <h5 className="mb-8 text-sm sm:text-xl text-justify gilroyMedium">We offer everything you need for your workplace, including complete interiors, renovations, and modular solutions. We provide a large selection of furniture and decor, so we can help you from beginning to end.</h5>
     ...
     <Card className="max-w-[24rem] m-auto col-span-12 md:col-span-6 lg:col-span-3 overflow-hidden in-detcards">
      ...
      <div className="title-container">
            <div className="gold-line"></div>
            <h1 className="title gilroyBold text-r-tvoi text-xl md:text-2xl lg:text-4xl  text-justify
            "> Modular: Transforming Aspirations into Inspirational Workspaces.</h1>
            </div>
